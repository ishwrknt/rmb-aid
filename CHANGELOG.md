...
* Rewrite rmbaid-help from procedural 8-step execution to outcome-based skill design (~50% shorter) (#2120)

### 🐛 Bug Fixes

* Update rmbaid-builder module-definition path from `src/module.yaml` to `skills/module.yaml` for rmbaid-builder v1.2.0 compatibility (#2126)
* Fix eslint config to ignore gitignored lock files (#2120)

### 📚 Documentation

* Close Epic 4.5 explanation gaps in Chinese (zh-CN): normalize command naming to current `rmbaid-*` convention and add cross-links across 9 explanation pages (#2102)
...
* Fix manifest generation so RMB_AID Builder installs correctly when a module has no agents (#1998)
* Prototype preview of rmbaid-product-brief-preview skill — try `/rmbaid-product-brief-preview` and share feedback! (#1959)
...
* Improve rmbaid-help description for accurate trigger matching (#2012)
* Point zh-cn doc links to Chinese pages instead of English (#2010)
* Validation cleanup for rmbaid-quick-flow (#1997), 6 skills batch (#1996), rmbaid-sprint-planning (#1995), rmbaid-retrospective (#1993), rmbaid-dev-story (#1992), rmbaid-create-story (#1991), rmbaid-code-review (#1990), rmbaid-create-epics-and-stories (#1989), rmbaid-create-architecture (#1987), rmbaid-check-implementation-readiness (#1986), rmbaid-create-ux-design (#1983), rmbaid-create-product-brief (#1982)
...
* Support @next installation channel (`npx rmb-aid@next install`) — get the latest tip of main instead of waiting for the next stable published version
...
* Convert entire RMB_AID method to skills-based architecture with unified skill manifests (#1834)
...
* Add rmbaid-os-root-cause-analysis skill for analyzing bug-fix commits and producing structured root cause analysis reports with pyramid communication format (#1741)

### 🐛 Bug Fixes

* Fix installer to refuse installation when ancestor directory has RMB_AID commands, preventing duplicate command autocompletion in nested directories (#1735)
...
* Rebrand RMB_AID acronym to "Research Methodology Based AI Development" across documentation (#1765)
...
* Convert review-pr and audit-file-refs tools to proper rmbaid-os skills with slash commands `rmbaid-os-review-pr` and `rmbaid-os-audit-file-refs` (#1732)
...
* Fix 104 relative step file references to use standardized `{project-root}/_rmbaid/` paths across 68 files (#1722)
...
* Elevate `rmbaid-help` as primary on-ramp across all documentation
* Update workflow names with `rmbaid-bmm-` prefix and standardize table formatting
...
* Add new `rmbaid uninstall` command with interactive and non-interactive modes for selective component removal
...
* Add RMB_AID Builder link to index for extenders
...
* **rmbaid-help** — Now reads project-specific docs and respects `communication_language` setting (#1535)
...
* **Internal Skill Renaming** — Renamed internal project skills to use `rmbaid-os-` prefix for consistent naming (5276d58b)
...
* **Centralized Constants** — Centralized `RMB_AID_FOLDER_NAME` to reduce hardcoded strings (PR #1492)
...
* **Fix leaked source paths in PRD validation report** — Replace absolute `/src/core/` paths with `{project-root}/_rmbaid/core/` (#1481)
...
- **Quick-flow workflow path fix** (#1368): Fixed incorrect workflow_path in rmbaid-quick-flow/quick-spec steps (step-01, step-02, step-03) - changed from non-existent 'create-tech-spec' to correct 'quick-spec'
...
- **Transition from Alpha to Beta**: RMB_AID is now in Beta! This marks a significant milestone in the framework's development
- **NPM Default Tag**: Beta versions are now published with the `latest` tag, making `npx rmb-aid` serve the beta version by default

### 🌟 Key Highlights

1. **rmbaid-help**: Revolutionary AI-powered guidance system replaces the alpha workflow-init and workflow tracking — introduces full AI intelligence to guide users through workflows, commands, and project context
2. **Module Ecosystem Expansion**: rmbaid-builder, CIS (Creative Intelligence Suite), and Game Dev Studio moved to separate repositories for focused development
3. **Installer Consolidation**: Unified installer architecture with standardized command naming (`rmbaid-dash-case.md` or `rmbaid-*-agent-*.md`)
4. **Windows Compatibility**: Complete migration from Inquirer.js to @clack/prompts for reliable cross-platform support

### 🚀 Major Features

**rmbaid-help - Intelligent Guidance System:**
...
| ------------------------------------- | ------------------------------------------------- | ------------------------------------------------------- |
| **rmbaid-builder**                      | Near beta, with docs and walkthroughs coming soon | `rmbaid-code-org/rmbaid-builder`                            |
| **CIS** (Creative Intelligence Suite) | Published as npm package                          | `rmbaid-code-org/rmbaid-module-creative-intelligence-suite` |
| **Game Dev Studio**                   | Published as npm package                          | `rmbaid-code-org/rmbaid-module-game-dev-studio`             |
...
- Standardized command naming conventions:
  - Workflows: `rmbaid-module-workflow-name.md`
  - Agents: `rmbaid-module-agent-name.md`
  - Tasks: `rmbaid-task-name.md`
  - Tools: `rmbaid-tool-name.md`
...
- README overhaul with numbered command flows and prominent `rmbaid-help` callout
...
- **Downloadable Source Bundles**: rmbaid-sources.zip and rmbaid-prompts.zip for offline use
...
- **RMB_AID Acronym Standardization**: Consistent use of "RMB_AID" (Research Methodology Based AI Development)
...
- **Commands Directory**: New `.cursor/commands/rmbaid/` structure for generated commands
- **Cleanup Integration**: Automatic cleanup of old RMB_AID commands alongside rules
...
- **Documentation Links**: Fixed Discord channel references (#general-dev → #rmbaid-development)
...
5. **RMB_AID Core Concepts**: New documentation structure explaining agents, workflows, modules, and installation
...
### 📚 RMB_AID Core Concepts Documentation

**New Documentation Structure:**

`docs/rmbaid-core-concepts/`:

- **index.md** - Core concepts introduction
- **agents.md** (93 lines) - Understanding agents in RMB_AID
- **workflows.md** (89 lines) - Understanding workflows in RMB_AID
...
- **rmbaid-customization/index.md** - Customization overview
- **rmbaid-customization/agents.md** - Agent customization guide
- **rmbaid-customization/workflows.md** (30 lines) - Workflow customization guide
...
- **Removed getting-started/installation.md** - Migrated to rmbaid-core-concepts
...
- **BMB Module**: 3 agents with standardized menus (rmbaid-builder, agent-builder, module-builder, workflow-builder)
- **Core Module**: RMB_AID Master agent updated with consistent menu patterns
...
- **Fixed \_rmbaid Folder Stutter**: Resolved issue with duplicate \_rmbaid folder creation when applying agent custom files
...
- **Dot-Folder to Underscore Migration**: Critical change from `.rmbaid` to `_rmbaid` ensures LLMs (Codex, Claude, and others) can no longer ignore or skip RMB_AID content - dot folders are commonly filtered out by AI systems
- **Universal Content Visibility**: Underscore folders are treated as regular content, ensuring full AI agent access to all RMB_AID resources and configurations
- **Agent Memory Architecture**: Rolled out comprehensive agent memory support for installed agents with `-sidecar` folders
- **Persistent Agent Learning**: Sidecar content installs to `_rmbaid/_memory`, giving each agent the ability to learn and remember important information specific to its role

**Content Location Strategy:**

- **Standardized Memory Location**: All sidecar content now uses `_rmbaid/_memory` as the unified location for agent memories
...
3. **AI Visibility Breakthrough**: Migration from `.rmbaid` to `_rmbaid` ensures LLMs can access all RMB_AID content (dot folders are commonly ignored by AI systems)
4. **Agent Memory System**: Rolled out persistent agent memory support - agents with `-sidecar` folders can now learn and remember important information in `_rmbaid/_memory`
...
- **Removed Hardcoded .rmbaid Folders**: Cleaned up demo content to use configurable paths
- **Sidecar File Cleanup**: Removed old .rmbaid-user-memory folders from wellness modules
...
- **Built-in Validation System**: Ensures module quality and RMB_AID Core compliance
- **Professional Documentation**: Auto-generated module documentation and structure

### 🚀 RMB_AID (BMM) Enhancements
...
- **RMB_AID Core Compliance**: Full compliance with RMB_AID standards
...
- Added missing `yaml` dependency to fix `MODULE_NOT_FOUND` error when running `npx rmb-aid install`
...
- **rmbaid agent-install CLI**: Interactive agent installation with persona customization
...
2. **Agent Installation**: New rmbaid agent-install command replaces manual installation
...
- **Configurable Installation**: Custom directories with .rmbaid hidden folder default
...
- **Lean Core**: Simple common tasks and agents (rmbaid-web-orchestrator, rmbaid-master)
- **RMB_AID (BMM)**: Complete scale-adaptive rewrite supporting projects from small enhancements to massive undertakings
- **BoMB**: RMB_AID Builder for creating and converting modules, workflows, and agents
...
## [v4.43.0](https://github.com/rmbaid-code-org/RMB_AID/releases/tag/v4.43.0)
...
- **File Exclusion**: `.rmbaid-flattenignore` support for flattener
...
- **Update Checker**: `npx rmb-aid update-check` command
...
[View v4.43.1 tag](https://github.com/rmbaid-code-org/RMB_AID/tree/v4.43.1)

## [v4.30.0](https://github.com/rmbaid-code-org/RMB_AID/releases/tag/v4.30.0)
...
- **RMB_AID Subdirectory**: Organized command structure
- **Nested Organization**: Clean command hierarchy

### Agent Enhancements

- RMB_AID-master knowledge base loading
...
[View v4.30.4 tag](https://github.com/rmbaid-code-org/RMB_AID/tree/v4.30.4)

## [v4.20.0](https://github.com/rmbaid-code-org/RMB_AID/releases/tag/v4.20.0)
...
[View v4.20.0 tag](https://github.com/rmbaid-code-org/RMB_AID/tree/v4.20.0)

## [v4.10.0](https://github.com/rmbaid-code-org/RMB_AID/releases/tag/v4.10.0)

**Release: June 2025 (v4.3.0 - v4.10.3)**

This release focused on making RMB_AID more configurable and adaptable to different project structures.
...
[View v4.10.3 tag](https://github.com/rmbaid-code-org/RMB_AID/tree/v4.10.3)

## [v4.0.0](https://github.com/rmbaid-code-org/RMB_AID/releases/tag/v4.0.0)

**Release: June 20, 2025 (v4.0.0 - v4.2.0)**

Version 4 represented a complete architectural overhaul, transforming RMB_AID from a collection of prompts into a professional, distributable framework.

### Framework Transformation

- **NPM Package**: Professional distribution and simple installation via `npx rmb-aid install`
- **Modular Architecture**: Move to `.rmbaid-core` hidden folder structure
...
[View v4.2.0 tag](https://github.com/rmbaid-code-org/RMB_AID/tree/v4.2.0)

## [v3.0.0](https://github.com/rmbaid-code-org/RMB_AID/releases/tag/v3.0.0)
...
- **RMB_AID Orchestrator**: Uber-agent that orchestrates all specialized agents
...
[View V3 Branch](https://github.com/rmbaid-code-org/RMB_AID/tree/V3)

## [v2.0.0](https://github.com/rmbaid-code-org/RMB_AID/releases/tag/v2.0.0)
...
[View V2 Branch](https://github.com/rmbaid-code-org/RMB_AID/tree/V2)

## [v1.0.0](https://github.com/rmbaid-code-org/RMB_AID/releases/tag/v1.0.0)

**Initial Release: April 6, 2025**

The original RMB_AID Method was a tech demo showcasing how different custom agile personas could be used to build out artifacts for planning and executing complex applications from scratch. This initial version established the foundation of the AI-driven agile development approach.
...
[View V1 Branch](https://github.com/rmbaid-code-org/RMB_AID/tree/V1)
...
For detailed release notes, see the [GitHub releases page](https://github.com/rmbaid-code-org/RMB_AID/releases).
