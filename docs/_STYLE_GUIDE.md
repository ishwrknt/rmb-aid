...
| Skill        | Agent   | Purpose                              |
| ------------ | ------- | ------------------------------------ |
| `rmbaid-brainstorming` | Analyst | Brainstorm a new project             |
| `rmbaid-create-prd`        | PM      | Create Product Requirements Document |
```
...
Only for RMB_AID and Enterprise tracks. Quick Flow skips to implementation.
