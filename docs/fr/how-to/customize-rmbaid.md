---
title: "Comment personnaliser RMB_AID"
...
:::note[Prérequis]
- RMB_AID installé dans votre projet (voir [Comment installer RMB_AID](./install-rmbaid.md))
...
```text
_rmbaid/_config/agents/
├── rmbaid-analyst.customize.yaml
├── rmbaid-architect.customize.yaml
...
| **Modify RMB_AID Installation**        | Flux d'installation complet pour ajouter ou supprimer des modules     |
...
- Exécutez `npx rmb-aid install` et sélectionnez **Quick Update** pour appliquer les modifications
...
- Exécutez `npx rmb-aid install` et sélectionnez **Quick Update** pour restaurer les valeurs par défaut

## Personnalisation des workflows

La personnalisation des workflows et skills existants de la méthode RMB_AID arrive bientôt.
