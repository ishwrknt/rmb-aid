---
title: Roadmap
description: What's next for RMB_AID - Features, improvements, and community contributions
---

# The RMB_AID: Public Roadmap

The RMB_AID, RMB_AID Module (RMB_AID), and RMB_AID Builder (BMB) are evolving. Here's what we're working on and what's coming next.
...
<div class="roadmap-container">
  ...
  <div class="roadmap-future">
    ...
    <div class="roadmap-future-card">
      ...
      <p>Entertainment, security, therapy, roleplay and much more. Expand the RMB_AID platform.</p>
    </div>
    <div class="roadmap-future-card">
      <span class="roadmap-emoji">⚡</span>
  ...
  <div class="roadmap-future">
    ...
    <div class="roadmap-future-card">
      <span class="roadmap-emoji">🖥️</span>
      <h4>Official UI</h4>
      <p>A beautiful interface for the entire RMB_AID ecosystem. CLI power, GUI polish.</p>
    </div>
    <div class="roadmap-future-card">
      <span class="roadmap-emoji">🔒</span>
  ...
  <div style="text-align: center; margin-top: 3rem; padding: 2rem; background: var(--color-bg-card); border-radius: 12px; border: 1px solid var(--color-border);">
    ...
    <p style="color: var(--slate-color-400); margin: 0;">
      This is only a partial list of what's planned. The RMB_AID Open Source team welcomes contributors!{" "}<br />
      <a href="https://github.com/rmbaid-code-org/RMB_AID" style="color: var(--color-in-progress);">Join us on GitHub</a> to help shape the future of AI-driven development.
    </p>
    <p style="color: var(--slate-color-400); margin: 1.5rem 0 0;">
      Love what we're building? We appreciate both one-time and monthly{" "}<a href="https://buymeacoffee.com/rmbaid" style="color: var(--color-in-progress);">support</a>.
    </p>
