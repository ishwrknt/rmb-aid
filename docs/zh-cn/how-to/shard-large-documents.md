...
当单个 Markdown 文档过大、影响模型读取时，可使用 `rmbaid-shard-doc` 工作流把文档拆成按章节组织的小文件，降低上下文压力。
...
- [如何自定义 RMB_AID](./customize-rmbaid.md) - 了解高级配置与工作流定制边界
