---
title: "How to Install RMB_AID"
description: Step-by-step guide to installing RMB_AID in your project
sidebar:
  order: 1
---

Use the `npx rmb-aid install` command to set up RMB_AID in your project with your choice of modules and AI tools.
...
- Starting a new project with RMB_AID
- Adding RMB_AID to an existing codebase
- Update the existing RMB_AID Installation
...
The installer will ask where to install RMB_AID files:
...
Some platforms require skills to be explicitly enabled in settings before they appear. If you install RMB_AID and don't see the skills, check your platform's settings or ask your AI assistant how to enable skills.
:::

### 4. Choose Modules

The installer shows available modules. Select whichever ones you need — most users just want **RMB_AID** (the software development module).
...
Run `rmbaid-help` to verify everything works and see what to do next.

**RMB_AID-Help is your intelligent guide** that will:
...
```
rmbaid-help I just installed, what should I do first?
rmbaid-help What are my options for a SaaS project?
```
...
**Installer worked but something doesn't work later** — Your AI needs RMB_AID context to help. See [How to Get Answers About RMB_AID](./get-answers-about-rmbaid.md) for how to point your AI at the right sources.
