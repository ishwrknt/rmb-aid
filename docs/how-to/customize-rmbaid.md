---
title: "How to Customize RMB_AID"
...
:::note[Prerequisites]
- RMB_AID installed in your project (see [How to Install RMB_AID](./install-rmbaid.md))
...
| **Modify RMB_AID Installation** | Full installation flow for adding or removing modules               |
...
- Run `npx rmb-aid install` and select **Quick Update** to apply changes
...
- Run `npx rmb-aid install` and select **Quick Update** to restore defaults

## Workflow Customization

Customization of existing RMB_AID workflows and skills is coming soon.
