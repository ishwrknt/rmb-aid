---
title: Lộ trình
description: Điều gì sẽ đến tiếp theo với RMB_AID - tính năng mới, cải tiến và đóng góp từ cộng đồng
---

# Lộ Trình Công Khai Của RMB_AID

RMB_AID, RMB_AID Module (RMB_AID) và RMB_AID Builder (BMB) đang tiếp tục phát triển. Đây là những gì chúng tôi đang thực hiện và sắp ra mắt.
...
<div class="roadmap-container">
  ...
  <div class="roadmap-future">
    ...
    <div class="roadmap-future-card">
      ...
      <p>Giải trí, bảo mật, trị liệu, roleplay và nhiều hơn nữa. Mở rộng nền tảng RMB_AID.</p>
    </div>
    <div class="roadmap-future-card">
      <span class="roadmap-emoji">⚡</span>
  ...
  <div class="roadmap-future">
    ...
    <div class="roadmap-future-card">
      ...
      <p>Một giao diện đẹp cho toàn bộ hệ sinh thái RMB_AID. Sức mạnh của CLI, độ hoàn thiện của GUI.</p>
    </div>
    <div class="roadmap-future-card">
      <span class="roadmap-emoji">🔒</span>
  ...
  <div style="text-align: center; margin-top: 3rem; padding: 2rem; background: var(--color-bg-card); border-radius: 12px; border: 1px solid var(--color-border);">
    ...
    <p style="color: var(--slate-color-400); margin: 0;">
      Đây mới chỉ là một phần của những gì đang được lên kế hoạch. Đội ngũ mã nguồn mở RMB_AID luôn chào đón contributor!<br />
      <a href="https://github.com/rmbaid-code-org/RMB_AID" style="color: var(--color-in-progress);">Tham gia cùng chúng tôi trên GitHub</a> để cùng định hình tương lai của phát triển phần mềm hướng AI.
    </p>
    <p style="color: var(--slate-color-400); margin: 1.5rem 0 0;">
      Nếu bạn thích những gì chúng tôi đang xây dựng, chúng tôi trân trọng cả <a href="https://buymeacoffee.com/rmbaid" style="color: var(--color-in-progress);">hỗ trợ</a> một lần lẫn hàng tháng.
    </p>
