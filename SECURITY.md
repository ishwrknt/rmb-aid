...
We recommend always using the latest version of RMB_AID to ensure you have the most recent security updates.
...
1. **GitHub Security Advisories** (Preferred): Use [GitHub's private vulnerability reporting](https://github.com/rmbaid-code-org/RMB_AID/security/advisories/new) to submit a confidential report.
...
- Vulnerabilities in RMB_AID core framework code
...
We appreciate the security research community's efforts in helping keep RMB_AID secure. Contributors who report valid security issues will be acknowledged in our security advisories.

---

Thank you for helping keep RMB_AID and our community safe.
