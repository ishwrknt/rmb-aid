...
const NAME_REGEX = /^rmbaid-[a-z0-9]+(-[a-z0-9]+)*$/;
...
function validateSkill(skillDir) {
  ...
  // TODO: rmbaid-agent-tech-writer has sub-skill files with intentional name/description
  const WF_SKIP_SKILLS = new Set(['rmbaid-agent-tech-writer']);
