...
validationWorkflow: '{project-root}/_rmbaid/rmbaid-skills/2-plan-workflows/rmbaid-validate-prd/steps-v/step-v-01-discovery.md'
---
...
**PRD Status:**
- Format: {RMB_AID Standard / RMB_AID Variant / Legacy (converted)}
