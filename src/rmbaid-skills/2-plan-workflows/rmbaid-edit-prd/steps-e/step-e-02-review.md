...
2. Analyze against RMB_AID standards (from prd-purpose.md)
...
- IF A: Invoke the `rmbaid-advanced-elicitation` skill, then return to discussion
- IF P: Invoke the `rmbaid-party-mode` skill, then return to discussion
