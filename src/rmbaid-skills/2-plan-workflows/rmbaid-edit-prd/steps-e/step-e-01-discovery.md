...
prdPurpose: '{project-root}/_rmbaid/rmbaid-skills/2-plan-workflows/rmbaid-create-prd/data/prd-purpose.md'
---
...
- 🎯 Detect PRD format (RMB_AID/legacy)
...
This file defines what makes a great RMB_AID PRD. Internalize this understanding - it will guide improvement recommendations.
...
- Convert to RMB_AID format (if legacy PRD)
...
**Check for RMB_AID PRD core sections:**
1. Executive Summary
2. Success Criteria
3. Product Scope
4. User Journeys
...
**Classify format:**
- **RMB_AID Standard:** 5-6 core sections present
- **RMB_AID Variant:** 3-4 core sections present, generally follows RMB_AID patterns
- **Legacy (Non-Standard):** Fewer than 3 core sections, does not follow RMB_AID structure

### 8. Route Based on Format and Context

**IF validation report provided OR PRD is RMB_AID Standard/Variant:**
...
**[C] Convert to RMB_AID Format** - Convert PRD to RMB_AID standard structure, then apply your edits
...
- RMB_AID PRDs proceed directly to review step
