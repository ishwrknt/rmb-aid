...
- RMB_AID PRD standards: Load from prd-purpose.md

**Tasks:**
1. Read current PRD section
2. Apply specified changes
3. Ensure RMB_AID PRD principles compliance:
...
- Restructuring: Reformat content to RMB_AID standard
...
**For restructuring:**
- Reorganize PRD to RMB_AID standard structure
- Ensure proper ## Level 2 headers
- Reorder sections logically
- Update PRD frontmatter to match RMB_AID format

**Follow RMB_AID PRD structure:**
1. Executive Summary
2. Success Criteria
3. Product Scope
4. User Journeys
...
RMB_AID standard structure applied.
