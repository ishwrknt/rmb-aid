...
Analyze legacy PRD against RMB_AID standards, identify gaps, propose conversion strategy, and let user choose how to proceed.
...
- ✅ You bring RMB_AID standards expertise and conversion guidance
...
- 🎯 Analyze legacy PRD against RMB_AID standard
...
**For each RMB_AID PRD section, analyze:**
...
- Manually check PRD for each RMB_AID section
...
**[R] Restructure to RMB_AID** - Full conversion to RMB_AID format, then apply your edits
...
- All 6 RMB_AID core sections analyzed for gaps
