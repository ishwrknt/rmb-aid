...
- Invoke the `rmbaid-advanced-elicitation` skill with the current design direction content
...
- Invoke the `rmbaid-party-mode` skill with the current design direction
