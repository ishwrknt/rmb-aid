...
- Invoke the `rmbaid-advanced-elicitation` skill with the current core experience content
...
- Invoke the `rmbaid-party-mode` skill with the current core experience definition
