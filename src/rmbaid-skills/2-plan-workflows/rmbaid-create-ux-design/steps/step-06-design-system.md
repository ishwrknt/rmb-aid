...
- Invoke the `rmbaid-advanced-elicitation` skill with the current design system content
...
- Invoke the `rmbaid-party-mode` skill with the current design system choice
