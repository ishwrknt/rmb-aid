...
- Invoke the `rmbaid-advanced-elicitation` skill with the current emotional response content
...
- Invoke the `rmbaid-party-mode` skill with the current emotional response definition
