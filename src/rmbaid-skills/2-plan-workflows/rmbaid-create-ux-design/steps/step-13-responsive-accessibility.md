...
- When 'A' selected: Invoke the `rmbaid-advanced-elicitation` skill
- When 'P' selected: Invoke the `rmbaid-party-mode` skill
...
- Invoke the `rmbaid-advanced-elicitation` skill with the current responsive/accessibility content
...
- Invoke the `rmbaid-party-mode` skill with the current responsive/accessibility strategy
