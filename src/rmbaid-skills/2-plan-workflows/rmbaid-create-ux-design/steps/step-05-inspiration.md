...
- Invoke the `rmbaid-advanced-elicitation` skill with the current inspiration analysis content
...
- Invoke the `rmbaid-party-mode` skill with the current inspiration analysis
