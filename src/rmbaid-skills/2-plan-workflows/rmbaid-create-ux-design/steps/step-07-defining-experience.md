...
- Invoke the `rmbaid-advanced-elicitation` skill with the current defining experience content
...
- Invoke the `rmbaid-party-mode` skill with the current defining experience
