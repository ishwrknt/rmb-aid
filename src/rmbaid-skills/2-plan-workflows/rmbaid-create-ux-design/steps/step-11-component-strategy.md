...
- Invoke the `rmbaid-advanced-elicitation` skill with the current component strategy content
...
- Invoke the `rmbaid-party-mode` skill with the current component strategy
