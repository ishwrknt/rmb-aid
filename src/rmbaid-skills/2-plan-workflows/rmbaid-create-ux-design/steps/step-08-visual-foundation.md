...
- Invoke the `rmbaid-advanced-elicitation` skill with the current visual foundation content
...
- Invoke the `rmbaid-party-mode` skill with the current visual foundation
