...
This file contains the RMB_AID PRD philosophy, standards, and validation criteria that will guide all validation checks. Internalize this understanding - it defines what makes a great RMB_AID PRD.
...
- IF A: Invoke the `rmbaid-advanced-elicitation` skill, and when finished redisplay the menu
- IF P: Invoke the `rmbaid-party-mode` skill, and when finished redisplay the menu
