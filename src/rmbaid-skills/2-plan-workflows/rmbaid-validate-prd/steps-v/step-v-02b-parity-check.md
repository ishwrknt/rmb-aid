...
Analyze non-standard PRD and identify gaps to achieve RMB_AID PRD parity, presenting user with options for how to proceed.
...
- ✅ You bring RMB_AID PRD standards expertise and gap analysis
...
- 🎯 Analyze each RMB_AID PRD section for gaps
...
### 1. Analyze Each RMB_AID PRD Section

For each of the 6 RMB_AID PRD core sections, analyze:
...
**Overall Effort to Reach RMB_AID Standard:** [Quick/Moderate/Substantial]
...
Your PRD is missing {count} of 6 core RMB_AID PRD sections. The overall effort to reach RMB_AID standard is: **{effort level}**
...
- All 6 RMB_AID PRD sections analyzed for gaps
