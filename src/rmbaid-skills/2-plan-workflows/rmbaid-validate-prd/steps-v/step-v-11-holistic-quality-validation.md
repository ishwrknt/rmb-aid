...
Assess the PRD as a cohesive, compelling document - evaluating document flow, dual audience effectiveness (humans and LLMs), RMB_AID PRD principles compliance, and overall quality rating.
...
- 🎯 Evaluate document flow, dual audience, RMB_AID principles
...
Invoke the `rmbaid-advanced-elicitation` skill
...
**3. RMB_AID PRD Principles Compliance:**
...
- Check RMB_AID principles compliance
...
### RMB_AID PRD Principles Compliance
...
- RMB_AID PRD principles compliance checked
...
- Not checking all RMB_AID principles
